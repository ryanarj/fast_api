...
def _get_schema(
    type_: Any, config_wrapper: _config.ConfigWrapper, parent_depth: int
) -> CoreSchema:
...
class TypeAdapter(Generic[T]):
    ...
    if TYPE_CHECKING:
        ...
        @overload
        def __new__(
            cls, __type: type[T], *, config: ConfigDict | None = ...
        ) -> TypeAdapter[T]:
            ...
        ...
        @overload
        def __new__(
            cls, __type: T, *, config: ConfigDict | None = ...
        ) -> TypeAdapter[T]:
            ...

        def __new__(
            cls, __type: Any, *, config: ConfigDict | None = None
        ) -> TypeAdapter[T]:
    ...
    def __init__(
        ...
        *,
        ...
        try:
            type_has_config = (
                issubclass(type, BaseModel) or is_dataclass(type) or is_typeddict(type)
            )
        except TypeError:
            # type is not a class
        ...
        try:
            ...
            core_schema = _get_schema(
                type, config_wrapper, parent_depth=_parent_depth + 1
            )
    ...
    def validate_python(
        ...
        *,
        ...
        return self.validator.validate_python(
            __object, strict=strict, from_attributes=from_attributes, context=context
        )
