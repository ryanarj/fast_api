...
if TYPE_CHECKING:
    ...
    _PlainSerializationFunction = Union[
        _core_schema.SerializerFunction, _PartialClsOrStaticMethod
    ]
    _WrapSerializationFunction = Union[
        _core_schema.WrapSerializerFunction, _PartialClsOrStaticMethod
    ]
    _PlainSerializeMethodType = TypeVar(
        "_PlainSerializeMethodType", bound=_PlainSerializationFunction
    )
    _WrapSerializeMethodType = TypeVar(
        "_WrapSerializeMethodType", bound=_WrapSerializationFunction
    )
