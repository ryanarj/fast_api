...
class AfterValidator:
    ...
    def __get_pydantic_core_schema__(
        self, source_type: Any, handler: _GetCoreSchemaHandler
    ...
    def __get_pydantic_core_schema__(
        ...
        if info_arg:
            ...
            return core_schema.with_info_plain_validator_function(
                func, field_name=handler.field_name
            )
        else:
            func = cast(core_schema.NoInfoValidatorFunction, self.func)
...
if TYPE_CHECKING:
    ...
    class _V2ValidatorClsMethod(Protocol):
        def __call__(
            self, __cls: Any, __input_value: Any, __info: _core_schema.ValidationInfo
        ) -> Any:
            ...
    ...
    _V2WrapValidatorType = TypeVar(
        "_V2WrapValidatorType", _V2WrapValidator, _PartialClsOrStaticMethod
    )
